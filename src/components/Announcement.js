...
export default class Announcement extends React.Component {
  render() {
    ...
    let align_x =
      _.get(site, "data.config.header.anncmnt_align", null) || "left";
    let has_close_btn = _.get(
      site,
      "data.config.header.anncmnt_has_close",
      null
    );
    return (
      <div
        ...
        {...(has_close_btn
          ? {
              "data-anncmnt-id": _.get(
                site,
                "data.config.header.anncmnt_id",
                null
              ),
            }
          : null)}
      >
        <div className="container">
          <div className="announcement-bar__content">
            ...
            >
              {markdownify(
                _.get(site, "data.config.header.anncmnt_content", null)
              )}
            </div>
            {has_close_btn && (
              <button
