        ...
        >
          ...
          >
            <div className="section__content grid items-center">
              {has_text && (
                <div
                  className={classNames("section__body", "my-1", "cell-12", {
                    "cell-md-7":
                      is_horiz && has_actions && actions_width === "fourty",
                    "cell-md-6":
                      is_horiz && has_actions && actions_width === "fifty",
                    "cell-md-5":
                      is_horiz && has_actions && actions_width === "sixty",
                ...
                >
                  ...
                  {_.get(section, "content", null) && (
                    <div className="section__copy text-block">
              ...
              {has_actions && (
                <div
                  className={classNames("section__actions", "my-1", "cell-12", {
                    "cell-md-5":
                      is_horiz && has_text && actions_width === "fourty",
                    "cell-md-6":
                      is_horiz && has_text && actions_width === "fifty",
                    "cell-md-7":
                      is_horiz && has_text && actions_width === "sixty",
                    "order-md-first": has_actions && actions_pos === "left",
                    "order-first": has_actions && actions_pos === "top",
                  })}
                >
                  <div
