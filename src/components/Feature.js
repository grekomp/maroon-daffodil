            ...
            {has_media && (
              <div
                className={classNames("feature__media", "my-2", "cell-12", {
                  "cell-md-4":
                    is_horiz && has_text && media_width === "thirty-three",
                  "cell-md-5": is_horiz && has_text && media_width === "fourty",
                  "cell-md-6": is_horiz && has_text && media_width === "fifty",
                  "cell-md-7": is_horiz && has_text && media_width === "sixty",
                })}
              >
                {_.get(feature, "video_embed_html", null) ? (
            ...
            {has_text && (
              <div
                className={classNames("feature__body", "my-2", "cell-12", {
                  "cell-md-8":
                    is_horiz && has_media && media_width === "thirty-three",
                  "cell-md-7":
                    is_horiz && has_media && media_width === "fourty",
                  "cell-md-6": is_horiz && has_media && media_width === "fifty",
                  "cell-md-5": is_horiz && has_media && media_width === "sixty",
              ...
              >
                {_.get(feature, "title", null) &&
                  (_.get(section, "title", null) ? (
                    <h3 className="feature__title h2">
                      {_.get(feature, "title", null)}
                    </h3>
                  ) : (
                    <h2 className="feature__title h2">
                      {_.get(feature, "title", null)}
                    </h2>
                  ))}
                {_.get(feature, "subtitle", null) && (
