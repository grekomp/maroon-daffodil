          ...
          >
            <div
              className={classNames("section__content", "grid", {
                "items-center": is_horiz && align_y === "middle",
                "items-end": is_horiz && align_y === "bottom",
              })}
            >
              {has_text && (
                <div
                  className={classNames("section__copy", "my-2", "cell-12", {
                    "cell-md-7": is_horiz && form_width === "fourty",
                    "cell-md-6": is_horiz && form_width === "fifty",
                    "cell-md-5": is_horiz && form_width === "sixty",
              ...
              <div
                className={classNames("section__form", "my-2", "cell-12", {
                  "cell-md-5": is_horiz && has_text && form_width === "fourty",
                  "cell-md-6": is_horiz && has_text && form_width === "fifty",
                  "cell-md-7": is_horiz && has_text && form_width === "sixty",
                  "order-first": form_pos === "top" || form_pos === "left",
                })}
              >
                <form
