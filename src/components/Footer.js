    ...
    return (
      <React.Fragment>
        <footer className="site-footer">
          {(has_logo ||
            _.get(this.props, "data.config.footer.has_primary_nav", null) ||
            _.get(this.props, "data.config.footer.has_secondary_nav", null) ||
            _.get(this.props, "data.config.footer.has_tertiary_nav", null)) && (
                ...
                >
                  {has_logo && (
                    ...
                    >
                      <img
                        src={withPrefix(
                          _.get(this.props, "data.config.footer.logo", null)
                        )}
                        alt={_.get(
                          this.props,
                          "data.config.header.logo_alt",
                          null
                        )}
                      />
                    </Link>
                  ...
                  {_.get(
                    this.props,
                    "data.config.footer.has_primary_nav",
                    null
                  ) &&
                    _.get(
                      this.props,
                      "data.config.footer.primary_nav_links",
                      null
                    ) && (
                      <div className="site-footer__menu cell-12 cell-md my-3 my-md-4">
                        {_.get(
                          this.props,
                          "data.config.footer.primary_nav_title",
                          null
                        ) && (
                  ...
                  {_.get(
                    this.props,
                    "data.config.footer.has_secondary_nav",
                    null
                  ) &&
                    _.get(
                      this.props,
                      "data.config.footer.secondary_nav_links",
                      null
                    ) && (
                      <div className="site-footer__menu cell-12 cell-md my-3 my-md-4">
                        {_.get(
                          this.props,
                          "data.config.footer.secondary_nav_title",
                          null
                        ) && (
                          <h2 className="h4 mb-3 mb-md-4">
                            {_.get(
                  ...
                  {_.get(
                    this.props,
                    "data.config.footer.has_tertiary_nav",
                    null
                  ) &&
                    _.get(
                      this.props,
                      "data.config.footer.tertiary_nav_links",
                      null
                    ) && (
                      <div className="site-footer__menu cell-12 cell-md my-3 my-md-4">
                        {_.get(
                          this.props,
                          "data.config.footer.tertiary_nav_title",
                          null
                        ) && (
                          <h2 className="h4 mb-3 mb-md-4">
                            {_.get(
                  ...
                  {footer_social && (
                    ...
                    >
                      {_.map(
                        _.get(
                          this.props,
                          "data.config.footer.social_links",
                          null
                        ),
                        (link, link_idx) => {
