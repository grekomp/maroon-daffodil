        ...
        >
          <div
            className={classNames("item", {
              ...
              "card--horiz": is_card && is_horiz,
              "card--vert": is_card && is_vert,
              "p-3": is_card_has_padding || is_card_no_img_no_padding,
              "p-sm-4": is_card_has_padding || is_card_no_img_no_padding,
            })}
          >
            <div
            ...
            >
              {has_image && (
                <div
                  className={classNames({
                    "cell-12": is_horiz,
                    "cell-md-3": is_horiz && image_width === "twenty-five",
                    "cell-md-4": is_horiz && image_width === "thirty-three",
                    "cell-md-5": is_horiz && image_width === "fourty",
                    "cell-md-6": is_horiz && image_width === "fifty",
                    "cell-md-7": is_horiz && image_width === "sixty",
                  })}
                >
                  <div
                    className={classNames("item__media", {
                      ...
                      "card__media--top": is_card && image_pos === "top",
                      "card__media--bottom": is_card && image_pos === "bottom",
                      "card__media--left": is_card && image_pos === "left",
                      "card__media--right": is_card && image_pos === "right",
                      "mb-3":
                        image_pos !== "bottom" &&
                        has_text &&
                        is_card_no_padding === false,
                      "mb-md-0":
                        is_horiz && has_text && is_card_no_padding === false,
                      "ml-md-3":
                        image_pos === "right" &&
                        has_text &&
                        is_card_no_padding === false,
              ...
              {has_text && (
                <div
                  className={classNames({
                    "cell-12": is_horiz,
                    "cell-md-9": is_horiz && image_width === "twenty-five",
                    "cell-md-8": is_horiz && image_width === "thirty-three",
                    "cell-md-7": is_horiz && image_width === "fourty",
                    "cell-md-6": is_horiz && image_width === "fifty",
                    "cell-md-5": is_horiz && image_width === "sixty",
                    "order-md-first": has_image && image_pos === "right",
                    "order-first": has_image && image_pos === "bottom",
                    "mb-auto":
                      is_card &&
                      image_pos === "bottom" &&
                ...
                >
                  <div
                    className={classNames("item__body", {
                      "p-3": has_image && is_card_no_padding,
                      "px-sm-4": has_image && is_card_no_padding,
                      "pb-sm-4":
                        has_image &&
                        is_card_no_padding &&
                        image_pos !== "bottom",
                      "pt-sm-4":
                        ...
                        is_card_no_padding &&
                        image_pos === "bottom",
                      "py-md-4": has_image && is_card_no_padding && is_horiz,
                      "pr-md-4":
                        has_image && is_card_no_padding && image_pos === "left",
                      "pl-md-3":
                        has_image && is_card_no_padding && image_pos === "left",
                      "pl-md-4":
                        has_image &&
