...
export default class Post extends React.Component {
  render() {
    let has_image = false;
    let image_pos =
      _.get(this.props, "page.frontmatter.image_position", null) || "top";
            ...
            >
              ...
              >
                ...
                {_.get(this.props, "page.frontmatter.author", null) && (
                  <BlogPostAuthor
                    {...this.props}
                    author={_.get(this.props, "page.frontmatter.author", null)}
          ...
          <div className="container container--medium">
            ...
            {_.get(this.props, "page.frontmatter.tags", null) && (
              <footer className="post__footer mt-4 mt-md-5">
                <BlogPostTags
                  {...this.props}
                  tags={_.get(this.props, "page.frontmatter.tags", null)}
                />
              </footer>
            )}
          </div>
